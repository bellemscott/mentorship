  ...
  def make_map
      ...
      jobs_list.each do |j|
           if j.include? "Account" or j.include? "Audit" or j.include? "Bursar" or j.include? "Claims" or j.include? "Investment" or j.include? "Underwriter"
            ...
            if j.include? "Adjuster"
             ...
             if j.include? "Advertising"
              ...
              if j.include? "Aerial erector" or "Percision Engenieer"
            ...
            if j.include? "Care" or if j.include? "Youth"
                if @major_map.has_key?("Education")
                   @major_map["Education"].push(j)
                 else 
                    @major_map["Education"]=[]
           ...
           if j.include? "Neuro"
               ...
               helper("Biology",j)
               helper("Postbaccalaureate Premed Studies")
           end
        ...
        if j.include? "Engenieer" and j.include? "Software"
             helper("Physics",j)
             helper("Mathematics",j)
        end
